...
class Lazy<T extends Comparable<T>>{
    ...
    public <U extends Comparable<U>>Lazy<U> map(Function<? super T,? extends U> fn){
    ...
    public <U extends Comparable<U>,R extends Comparable<R>> Lazy<R> combine(Lazy<U> l, BiFunction<T,U,R> combi){
    ...
    public Lazy<Integer> compareTo(Lazy<T> l){
        return new Lazy<Integer>(()->this.get().compareTo(l.get()));
    }
    @Override
